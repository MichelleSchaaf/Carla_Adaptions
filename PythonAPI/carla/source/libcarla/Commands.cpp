...
void export_commands() {
  ...
  class_<cr::Command::ApplyCustomDepthStencilValue>("ApplyCustomDepthStencilValue")
      .def("__init__", &command_impl::CustomInit<ActorPtr, int>, (arg("actor"), arg("custom_depth_stencil_value")))
      .def(init<cr::ActorId, int>((arg("actor_id"), arg("custom_depth_stencil_value"))))
      .def_readwrite("actor_id", &cr::Command::ApplyCustomDepthStencilValue::actor)
      .def_readwrite("custom_depth_stencil_value", &cr::Command::ApplyCustomDepthStencilValue::custom_depth_stencil_value)
      ;
  // END NEW
  ...
  implicitly_convertible<cr::Command::ApplyCustomDepthStencilValue, cr::Command>(); // NEW
