...
// NEW - author: Michelle Schaaf
void FCarlaActor::SetStencilValue(UPrimitiveComponent& Component, int value)
{
    ...
    if (value == 1) {
        ...
        Component.SetCustomDepthStencilWriteMask(ERendererStencilMask::ERSM_2);
    }
    else if (value == 4) {
        Component.SetCustomDepthStencilWriteMask(ERendererStencilMask::ERSM_4);
    }
    else if (value == 8) {
        Component.SetCustomDepthStencilWriteMask(ERendererStencilMask::ERSM_8);
    }
    else if (value == 16) {
        Component.SetCustomDepthStencilWriteMask(ERendererStencilMask::ERSM_16);
    }
    else if (value == 32) {
        Component.SetCustomDepthStencilWriteMask(ERendererStencilMask::ERSM_32);
    }
    else if (value == 64) {
        Component.SetCustomDepthStencilWriteMask(ERendererStencilMask::ERSM_64);
    }
    else if (value == 128) {
        Component.SetCustomDepthStencilWriteMask(ERendererStencilMask::ERSM_128);
    }
}

void FCarlaActor::SetActorCustomDepthStencilValue(int bCustomDepthStencilValue)
{
    // Changes the CustomDepthStencilValue of StaticMeshComponents --> Vehicles
    TArray<UStaticMeshComponent*> StaticMeshComponents;
    GetActor()->GetComponents(StaticMeshComponents);
    for (UStaticMeshComponent* Component : StaticMeshComponents) {
        SetStencilValue(*Component, bCustomDepthStencilValue);

    }

    // Change the CustomDepthStencilValue of SkeletMeshComponents --> Walkers
    TArray<USkeletalMeshComponent*> SkeletalMeshComponents;
    GetActor()->GetComponents(SkeletalMeshComponents);
    for (USkeletalMeshComponent* Component : SkeletalMeshComponents) {
        SetStencilValue(*Component, bCustomDepthStencilValue);
    }

    // Change the CustomDepthStencilValue of the RootComponent
    auto RootComponent = Cast<UPrimitiveComponent>(GetActor()->GetRootComponent());
    RootComponent->SetCustomDepthStencilValue(bCustomDepthStencilValue);
    RootComponent->SetRenderCustomDepth(true);


    // Change the CustomDepthStencilMask accordingly to its new CustomDepthStencilValue
    if (bCustomDepthStencilValue == 1) {
        RootComponent->SetCustomDepthStencilWriteMask(ERendererStencilMask::ERSM_1);
    }
    else if (bCustomDepthStencilValue == 2) {
        RootComponent->SetCustomDepthStencilWriteMask(ERendererStencilMask::ERSM_2);
    }
    else if (bCustomDepthStencilValue == 4) {
        RootComponent->SetCustomDepthStencilWriteMask(ERendererStencilMask::ERSM_4);
    }
    else if (bCustomDepthStencilValue == 8) {
        RootComponent->SetCustomDepthStencilWriteMask(ERendererStencilMask::ERSM_8);
    }
    else if (bCustomDepthStencilValue == 16) {
        RootComponent->SetCustomDepthStencilWriteMask(ERendererStencilMask::ERSM_16);
    }
    else if (bCustomDepthStencilValue == 32) {
        RootComponent->SetCustomDepthStencilWriteMask(ERendererStencilMask::ERSM_32);
    }
    else if (bCustomDepthStencilValue == 64) {
        RootComponent->SetCustomDepthStencilWriteMask(ERendererStencilMask::ERSM_64);
    }
    else if (bCustomDepthStencilValue == 128) {
        RootComponent->SetCustomDepthStencilWriteMask(ERendererStencilMask::ERSM_128);
    }
