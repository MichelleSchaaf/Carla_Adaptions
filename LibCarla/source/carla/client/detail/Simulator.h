...
namespace detail {
  ...
  public:
    ...
    void SetActorCustomDepthStencilValue(Actor& actor, int custom_depth_stencil_value) {
        _client.SetActorCustomDepthStencilValue(actor.GetId(), custom_depth_stencil_value);
    }
    // END NEW
