...
namespace detail {
  ...
  void Client::SetActorCustomDepthStencilValue(rpc::ActorId actor, const int custom_depth_stencil_value) {
      _pimpl->AsyncCall("set_actor_custom_depth_stencil_value", actor, custom_depth_stencil_value);
  }
  // END NEW
