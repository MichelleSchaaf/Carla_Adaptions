...
namespace client {
  ...
  void Actor::SetCustomDepthStencilValue(const int custom_depth_stencil_value)
  {
      GetEpisode().Lock()->SetActorCustomDepthStencilValue(*this, custom_depth_stencil_value);
  }
  // END NEW
